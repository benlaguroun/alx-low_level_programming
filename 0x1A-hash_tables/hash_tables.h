 ...
 * @key: The unique key (string) in the HashTable
 ...
 * @array: An array of size @size, where each cell is a pointer to the
 *         first node of a linked list (used for Chaining collision handling).
 */
 ...
 * @key: The unique key (string) in the HashTable
 * @value: The value associated with the key
 * @next: A pointer to the next node in the unsorted linked list
